...
namespace MEVIO.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            int roleId = context.Roles.FirstOrDefault(r => r.UserRoleName.Equals("director")).Id;
            int userId = context.Users.FirstOrDefault(u => u.UserRoleId == roleId).Id;
        ...
        private void InitEducationForms()
        {
        ...
        {
            context.Roles.Add(new UserRole() { UserRoleName = "admin" });
            context.Roles.Add(new UserRole() { UserRoleName = "director" });
