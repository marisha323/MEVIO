        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Discount_Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DiscountSum = table.Column<double>(type: "float", nullable: true),
                    Birthdate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PathImgAVA = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: true),
                    WatchingPerson_Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WatchingPerson_TaskId = table.Column<int>(type: "int", nullable: true),
                    WatchingPerson_UnderTaskId = table.Column<int>(type: "int", nullable: true),
                    WatchingPerson_UserId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.WatchingPerson_TaskId,
                        principalTable: "Tasks",
                        principalColumn: "Id");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.WatchingPerson_UnderTaskId,
                        principalTable: "UnderTasks",
                        principalColumn: "Id");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.WatchingPerson_UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
